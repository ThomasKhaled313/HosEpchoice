                      ...
                      CarouselSlider(
                        items: [
                          button('القداس الباسيلي',
                              imagePath: 'assets/basyly.jpg'),
                          button('القداس الغريغوري',
                              imagePath: 'assets/gregory.jpg'),
                          button('القداس الكيرلسي',
                              imagePath: 'assets/kirollos.jpg'),
                          button('مردات الشماس',
                              imagePath: 'assets/stefanos.jpg'),
                          button('تسبحة نصف الليل',
                              imagePath: 'assets/tasbe7a.jpg'),
                        ],
                      ...
                      CarouselSlider(
                        items: [
                          button('طقس عيد النيروز',
                              imagePath: 'assets/nayrooz.jpg'),
                          button('طقس عيد الميلاد',
                              imagePath: 'assets/mylad.jpg'),
                          button('طقس عيد الغطاس',
                              imagePath: 'assets/ghotac.jpg'),
                          button('طقس عيد عُرس قانا الجليل',
                              imagePath: 'assets/kana.jpg'),
                          button('طقس عيد البشارة',
                              imagePath: 'assets/beshara.jpg'),
                          button('طقس عيد القيامة',
                              imagePath: 'assets/qyama.jpg'),
                          button('طقس عيد الصعود',
                              imagePath: 'assets/so3od.jpg'),
                          button('طقس عيد العنصرة',
                              imagePath: 'assets/3ansara.jpg'),
                          button('طقس عيد التجلي',
                              imagePath: 'assets/tagally.jpg'),
                        ],
                        options: CarouselOptions(
                          height: 300,
                          autoPlay: false,
                      ...
                      CarouselSlider(
                        items: [
                          button('طقس عيد الصليب',
                              imagePath: 'assets/saleeb.jpg'),
                          button('طقس أحد الشعانين',
                              imagePath: 'assets/a7ad_sha3aneen.jpg'),
                        ],
                        options: CarouselOptions(
                          height: 300,
                          autoPlay: false,
                      ...
                      CarouselSlider(
                        items: [
                          button('طقس البصخة المقدسة',
                              imagePath: 'assets/holy_week.jpg'),
                          button('طقس خميس العهد',
                              imagePath: 'assets/khamees_3ahd.jpg'),
                          button('طقس الجمعة العظيمة',
                              imagePath: 'assets/gom3a.jpg'),
                          button('طقس ليلة أبو غالمسيس',
                              imagePath: 'assets/abokalipses.jpg'),
                        ],
                        options: CarouselOptions(
                          height: 300,
                          autoPlay: false,
                      ...
                      CarouselSlider(
                        items: [
                          button('طقس أعياد يوحنا المعمدان',
                              imagePath: 'assets/yohanna.jpg'),
                          button('طقس شهر كيهك', imagePath: 'assets/kyahk.jpg'),
                          button('طقس برمون عيد الميلاد',
                              imagePath: 'assets/baramonMylad.jpg'),
                          button('طقس برمون عيد الغطاس',
                              imagePath: 'assets/baramonGhotac.jpg'),
                          button('طقس سبت لعازر',
                              imagePath: 'assets/sabtle3azar.jpg'),
                        ],
                        options: CarouselOptions(
                          height: 300,
                          autoPlay: false,
                      ...
                      CarouselSlider(
                        items: [
                          button('طقس صوم و فصح يونان',
                              imagePath: 'assets/yonan.jpg'),
                          button('طقس الصوم الكبير',
                              imagePath: 'assets/kbeer.jpg'),
                          button('طقس صوم العذراء و أعيادها',
                              imagePath: 'assets/3adra.jpg'),
                          button('طقس صوم الرسل و عيدهم',
                              imagePath: 'assets/rosol.jpg'),
                        ],
                        options: CarouselOptions(
                          height: 300,
                          autoPlay: false,
