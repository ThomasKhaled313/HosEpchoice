...
class Tasbe7et3asheyya extends StatefulWidget{
  String title;

  Tasbe7et3asheyya(this.title);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return Tasbe7et3asheyyaState(title);
  }
}

class Tasbe7et3asheyyaState extends State<Tasbe7et3asheyya>{
  String title;
  var url,urlasync;
  Tasbe7et3asheyyaState(this.title);
  ...
  getAudioName(title){
    switch(title){
      ...
      case 'Nie;noc' : return 'niethnos.mp3'; break;
